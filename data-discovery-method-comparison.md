...
**Generalization tests (same method, other diseases):** [glaucoma](glaucoma-method-comparison.md) · [systemic sclerosis (on-mission IID)](ssc-method-comparison.md) · [arthritis (broad umbrella)](arthritis-method-comparison.md) · [subclass-expansion recall: IBD](subclass-expansion-recall.md)
